...
def main():
    ...
    # Initialize env (for vectorized env, use DummyVecEnv([make_env(env_id, 0, args.seed)]). E.g. mandatory for PPO2)
    args = get_args()
    ...
    save_freq_RL, eval_freq_RL, save_freq_IL, eval_freq_IL, = 0, 0, 0, 0
    save_best_model, tensorboard_path, callback = False, None, None
